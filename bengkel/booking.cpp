...
BOOKING::BOOKING(QWidget *parent) :
    ...
    ui(new Ui::BOOKING)
{
    QPixmap pix1("C:/Users/Hairul Hafiq/Documents/Workshop/Pic/Dark-Red-Abstract-Images-HD-Wallpaper-Desktop.jpg");
...
void BOOKING::on_pushButtoncancel_clicked()
{
...
void BOOKING::on_pushButton__newform_clicked()
{
...
void BOOKING::on_pushButtonbooking_clicked()
{
...
void BOOKING::on_pushButton_logout_clicked()
{
    this->hide();
    LOGIN logout;
